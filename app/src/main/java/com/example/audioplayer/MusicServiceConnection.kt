 ...
 */
class MusicServiceConnection(context: Context, serviceComponent: ComponentName, bundle: Bundle) {
    ...
    private inner class MediaBrowserConnectionCallback(private val context: Context) :
        ...
        override fun onConnectionSuspended() {
            _isConnected.postValue(Event(Resource.errro("Connection was suspended", false)))
        }
        ...
        override fun onConnectionFailed() {
            _isConnected.postValue(Event(Resource.errro("Could not connect media broser", false)))
        }
    }
    ...
    private inner class MediaControllerCallback : MediaControllerCompat.Callback() {
        ...
        override fun onSessionEvent(event: String?, extras: Bundle?) {
            ...
            when (event) {
                NETWORK_FAILURE -> _networkError.postValue(
                    Event(
                        Resource.errro(
                            "Could not server, Please check again",
                            null
                        )
                    )
                )
    ...
    companion object {
        ...
        fun getInstance(context: Context, serviceComponent: ComponentName, bundle: Bundle) =
            instance ?: synchronized(this) {
                instance ?: MusicServiceConnection(context, serviceComponent, bundle)
                    .also { instance = it }
            }
    }
}
